...
function Banner({ info }) {
  const { banner_title, banner_img, string_data, quote, portrait, banner_link_one, banner_link_two , banner_icon } = info;
  return (
    <div className='banner'  >
      <div className="banner_text" style={!portrait ? { left: "15%", top: "45%", transform: "translateY(-50%)" } : {}}  >
        ...
        <p style={!portrait ? { color: "#fff" } : {}} className='tone' >{string_data}</p>
